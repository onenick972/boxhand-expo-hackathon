...
export const ALGOD_INDEX_SERVER =
  process.env.EXPO_PUBLIC_ALGOD_INDEX_SERVER ?? '';
export const ALGOD_PORT = process.env.EXPO_PUBLIC_ALGOD_PORT ?? '';

export const ALGO_SECRET_KEY = process.env.EXPO_WALLET_SECRET_KEY ?? ''; // Base64 encoded secret key for signing transactions
...
export const APP_DESCRIPTION =
  ...
  'Decentralized Micro-Savings Circles';
export const APP_URL = process.env.EXPO_PUBLIC_APP_URL ?? 'https://boxhand.app';
export const APP_ICON =
  process.env.EXPO_PUBLIC_APP_ICON ?? 'https://boxhand.app/icon.png';
