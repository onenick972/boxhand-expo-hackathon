/*
  # Trust Circles Schema

  1. Tables
    - circles: Stores circle information and settings
    - circle_members: Tracks circle membership and roles
    - circle_contributions: Records member contributions
  
  2. Security
    - RLS enabled on all tables
    - Policies for viewing, creating, and managing circles
    - Policies for member management
    - Policies for contribution tracking
